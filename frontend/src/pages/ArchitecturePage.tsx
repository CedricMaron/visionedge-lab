...
function Node({ title, sub, tone = 'accent' }: { title: string; sub: string; tone?: string }) {
  const tones: Record<string, string> = {
    ...
    neutral: 'border-strong bg-elevated',
  };
  return (
      ...
      <div className="grid gap-4 lg:grid-cols-[320px_1fr]">
        ...
        <div className="space-y-4">
          <div className="card card-pad">
            <h2 className="mb-2 text-sm font-semibold text-primary">Frontend layers</h2>
            <ul className="space-y-2 text-sm text-secondary">
              <li>
                <span className="font-medium text-primary">Services</span> — a thin typed fetch
              ...
              <li>
                <span className="font-medium text-primary">Stores</span> — zustand:{' '}
              ...
              <li>
                <span className="font-medium text-primary">Hooks</span> —{' '}
              ...
              <li>
                <span className="font-medium text-primary">Inference abstraction</span> — a shared{' '}
          ...
          <div className="card card-pad">
            <h2 className="mb-2 text-sm font-semibold text-primary">Execution locations</h2>
          ...
          <div className="card card-pad">
            <h2 className="mb-2 text-sm font-semibold text-primary">Roadmap</h2>
